...
query_groceries = "/grocery/household-care/basic-electricals/pr?sid=73z,cwl,0s4&marketplace=GROCERY"
...
def getGroceryBrands():
    brands = []
    with open("flipkart_brands_household_care_basic_electricals.txt", "r") as infile:
        for brand in infile:
...
def getGroceries():
    ...
    csvfile = open("flipkart_household_care_basic_electricals.csv", "w")
    jsonfile = open("flipkart_household_care_basic_electricals.json", "w")
    for brand in brands:
