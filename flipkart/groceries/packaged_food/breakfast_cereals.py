...
query_groceries = "/grocery/packaged-food/breakfast-cereals/pr?sid=73z,u0u,bx9&marketplace=GROCERY"
...
def getGroceryBrands():
    brands = []
    with open("flipkart_brands_packaged_food_breakfast_cereals.txt", "r") as infile:
        for brand in infile:
...
def getGroceries():
    ...
    csvfile = open("flipkart_brands_packaged_food_breakfast_cereals.csv", "w")
    jsonfile = open("flipkart_brands_packaged_food_breakfast_cereals.json", "w")
    for brand in brands:
