...
query_groceries = "/grocery/personal-baby-care/oral-care/pr?sid=73z,njl,2s3&marketplace=GROCERY"
...
def getGroceryBrands():
    brands = []
    with open("flipkart_brands_personal_baby_care_oral_care.txt", "r") as infile:
        for brand in infile:
...
def getGroceries():
    ...
    csvfile = open("flipkart_personal_baby_care_oral_care.csv", "w")
    jsonfile = open("flipkart_personal_baby_care_oral_care.json", "w")
    for brand in brands:
