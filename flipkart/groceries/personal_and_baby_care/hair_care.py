...
query_groceries = "/grocery/personal-baby-care/hair-care/pr?sid=73z,njl,vpw&marketplace=GROCERY"
...
def getGroceryBrands():
    brands = []
    with open("flipkart_brands_personal_baby_care_hair_care.txt", "r") as infile:
        for brand in infile:
...
def getGroceries():
    ...
    csvfile = open("flipkart_personal_baby_care_hair_care.csv", "w")
    jsonfile = open("flipkart_personal_baby_care_hair_care.json", "w")
    for brand in brands:
