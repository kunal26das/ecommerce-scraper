...
query_groceries = "/grocery/personal-baby-care/wellness-common-pharma/pr?sid=73z,njl,07d&marketplace=GROCERY"
query_brand = "&p%5B%5D=facets.brand%255B%255D%3D"
query_page = "&page="
category = "wellness_common_pharma"
...
def getGroceryBrands():
    brands = []
    with open("flipkart_brands_personal_baby_care_wellness_common_pharma.txt", "r") as infile:
        for brand in infile:
...
def getGroceries():
    ...
    csvfile = open("flipkart_personal_baby_care_wellness_common_pharma.csv", "w")
    jsonfile = open("flipkart_personal_baby_care_wellness_common_pharma.json", "w")
    for brand in brands:
