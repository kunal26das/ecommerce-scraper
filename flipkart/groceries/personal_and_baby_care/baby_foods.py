...
query_groceries = "/grocery/personal-baby-care/baby-foods/pr?sid=73z,njl,2jj&marketplace=GROCERY"
...
def getGroceryBrands():
    brands = []
    with open("flipkart_brands_personal_baby_care_baby_foods.txt", "r") as infile:
        for brand in infile:
...
def getGroceries():
    ...
    csvfile = open("flipkart_personal_baby_care_baby_foods.csv", "w")
    jsonfile = open("flipkart_personal_baby_care_baby_foods.json", "w")
    for brand in brands:
