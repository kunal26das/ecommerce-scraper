...
query_groceries = "/grocery/personal-baby-care/baby-bath-skin-care/pr?sid=73z,njl,m1f&marketplace=GROCERY"
query_brand = "&p%5B%5D=facets.brand%255B%255D%3D"
query_page = "&page="
category = "baby_bath_skin_care"
...
def getGroceryBrands():
    brands = []
    with open("flipkart_brands_personal_baby_care_baby_bath_skin_care.txt", "r") as infile:
        for brand in infile:
...
def getGroceries():
    ...
    csvfile = open("flipkart_personal_baby_care_baby_bath_skin_care.csv", "w")
    jsonfile = open("flipkart_personal_baby_care_baby_bath_skin_care.json", "w")
    for brand in brands:
