...
query_groceries = "/grocery/staples/ghee-oils/pr?sid=73z,bpe,4wu&marketplace=GROCERY"
...
def getGroceryBrands():
    brands = []
    with open("flipkart_brands_staples_ghee_oils.txt", "r") as infile:
        for brand in infile:
...
def getGroceries():
    ...
    csvfile = open("flipkart_brands_staples_ghee_oils.csv", "w")
    jsonfile = open("flipkart_brands_staples_ghee_oils.json", "w")
    for brand in brands:
