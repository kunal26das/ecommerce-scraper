...
query_groceries = "/grocery/staples/dals-pulses/pr?sid=73z%2Cbpe%2C3uv&marketplace=GROCERY"
...
def getGroceryBrands():
    brands = []
    with open("flipkart_brands_staples_dals_pulses.txt", "r") as infile:
        for brand in infile:
...
def getGroceries():
    ...
    csvfile = open("flipkart_brands_staples_dals_pulses.csv", "w")
    jsonfile = open("flipkart_brands_staples_dals_pulses.json", "w")
    for brand in brands:
