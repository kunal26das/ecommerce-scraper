...
query_groceries = "/grocery/dairy-eggs/eggs/pr?sid=73z,esa,hh7&marketplace=GROCERY"
...
def getGroceryBrands():
    brands = []
    with open("flipkart_brands_dairy_eggs_eggs.txt", "r") as infile:
        for brand in infile:
...
def getGroceries():
    ...
    csvfile = open("flipkart_dairy_eggs_eggs.csv", "w")
    jsonfile = open("flipkart_dairy_eggs_eggs.json", "w")
    for brand in brands:
