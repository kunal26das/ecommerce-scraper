...
query_groceries = "/grocery/dairy-eggs/dairy/pr?sid=73z,esa,dt6&marketplace=GROCERY"
...
def getGroceryBrands():
    brands = []
    with open("flipkart_brands_dairy_eggs_dairy.txt", "r") as infile:
        for brand in infile:
...
def getGroceries():
    ...
    csvfile = open("flipkart_dairy_eggs_dairy.csv", "w")
    jsonfile = open("flipkart_dairy_eggs_dairy.json", "w")
    for brand in brands:
