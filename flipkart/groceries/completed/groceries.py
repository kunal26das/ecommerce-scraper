...
query_groceries = "/grocery/pr?sid=73z&marketplace=GROCERY"
query_brand = "&cid=3AQCX60YD3IB&p%5B%5D=facets.brand%255B%255D%3D"
query_page = "&page="
category = "groceries"
...
def getGroceryBrands():
    brands = []
    with open("flipkart_brands_groceries.txt", "r") as infile:
        for brand in infile:
...
def getGroceries():
    ...
    csvfile = open("flipkart_groceries.csv", "w")
    jsonfile = open("flipkart_groceries.json", "w")
    for brand in brands:
