...
query_groceries = "/grocery/snacks-beverages/juices/pr?sid=73z,ujs,afd&marketplace=GROCERY"
...
def getGroceryBrands():
    brands = []
    with open("flipkart_brands_snacks_beverages_juices.txt", "r") as infile:
        for brand in infile:
...
def getGroceries():
    ...
    csvfile = open("flipkart_brands_snacks_beverages_juices.csv", "w")
    jsonfile = open("flipkart_brands_snacks_beverages_juices.json", "w")
    for brand in brands:
