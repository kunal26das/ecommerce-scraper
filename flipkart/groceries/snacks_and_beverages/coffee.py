...
query_groceries = "/grocery/snacks-beverages/coffee/pr?sid=73z,ujs,t7k&marketplace=GROCERY"
...
def getGroceryBrands():
    brands = []
    with open("flipkart_brands_snacks_beverages_coffee.txt", "r") as infile:
        for brand in infile:
...
def getGroceries():
    ...
    csvfile = open("flipkart_brands_snacks_beverages_coffee.csv", "w")
    jsonfile = open("flipkart_brands_snacks_beverages_coffee.json", "w")
    for brand in brands:
