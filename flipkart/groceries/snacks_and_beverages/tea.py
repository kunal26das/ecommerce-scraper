...
query_groceries = "/grocery/snacks-beverages/tea/pr?sid=73z,ujs,amr&marketplace=GROCERY"
...
def getGroceryBrands():
    brands = []
    with open("flipkart_brands_snacks_beverages_tea.txt", "r") as infile:
        for brand in infile:
...
def getGroceries():
    ...
    csvfile = open("flipkart_brands_snacks_beverages_tea.csv", "w")
    jsonfile = open("flipkart_brands_snacks_beverages_tea.json", "w")
    for brand in brands:
