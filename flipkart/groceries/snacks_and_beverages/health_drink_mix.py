...
query_groceries = "/grocery/snacks-beverages/health-drink-mix/pr?sid=73z,ujs,vnq&marketplace=GROCERY"
...
def getGroceryBrands():
    brands = []
    with open("flipkart_brands_snacks_beverages_health_drink_mix.txt", "r") as infile:
        for brand in infile:
...
def getGroceries():
    ...
    csvfile = open("flipkart_brands_snacks_beverages_health_drink_mix.csv", "w")
    jsonfile = open("flipkart_brands_snacks_beverages_health_drink_mix.json", "w")
    for brand in brands:
