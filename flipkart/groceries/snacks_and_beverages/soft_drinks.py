...
query_groceries = "/grocery/snacks-beverages/soft-drinks/pr?sid=73z,ujs,dfw&marketplace=GROCERY"
...
def getGroceryBrands():
    brands = []
    with open("flipkart_brands_snacks_beverages_soft_drinks.txt", "r") as infile:
        for brand in infile:
...
def getGroceries():
    ...
    csvfile = open("flipkart_brands_snacks_beverages_soft_drinks.csv", "w")
    jsonfile = open("flipkart_brands_snacks_beverages_soft_drinks.json", "w")
    for brand in brands:
