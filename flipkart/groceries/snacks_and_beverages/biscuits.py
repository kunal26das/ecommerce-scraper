...
query_groceries = "/grocery/snacks-beverages/biscuits/pr?sid=73z,ujs,eb9&marketplace=GROCERY"
...
def getGroceryBrands():
    brands = []
    with open("flipkart_brands_snacks_beverages_biscuits.txt", "r") as infile:
        for brand in infile:
...
def getGroceries():
    ...
    csvfile = open("flipkart_brands_snacks_beverages_biscuits.csv", "w")
    jsonfile = open("flipkart_brands_snacks_beverages_biscuits.json", "w")
    for brand in brands:
